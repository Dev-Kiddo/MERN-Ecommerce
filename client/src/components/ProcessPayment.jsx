  ...
  return (
    <>
      ...
      <div className="flex items-center flex-col sm:flex-row justify-center gap-3 mt-8">
        ...
        <button className="rounded-lg w-full  py-4 text-center justify-center items-center bg-blue-700 font-semibold text-lg text-white flex gap-2 transition-all duration-500 hover:bg-blue-800">
